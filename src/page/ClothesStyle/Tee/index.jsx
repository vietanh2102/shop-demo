...
function Tee() {
    ...
    const teeTotal = products.filter(item => item.detail === 'tee')
    const tee = teeTotal.slice(pagination.to,pagination.from)
    ...
    return (
        ...
        <div>
            ...
            <div className="flex  mx-0 sm:mx-[30px] md:mx-[10rem] lg:mx-[6rem] xl:mx-[10rem] pt-[71.16px] h-full">
                ...
                <div className="w-full">
                    <h1 className="font-bold text-[20px]">Tee</h1>
                    <div 
                    ...
                    {/* {showProduct} */}
                    {showFilter ? <ResultFilterTypeProduct detail='tee'  /> : 
                    ...
                    <div className="flex justify-end my-[20px]">
                        <Pagination 
                            count={Math.ceil(teeTotal.length / pageSize)}
